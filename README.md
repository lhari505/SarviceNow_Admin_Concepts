...
| **5** | [Condition Builder and Breadcrumbs](Section/Lesson5_Condition_Builder_and_Breadcrumbs.md) | Learn advanced filtering using Condition Builder, Breadcrumbs, saved filters, and reference fields | Create complex queries and efficiently manage ServiceNow data |
| **6** | [Context Menus in ServiceNow](Section/Lesson6_Context_Menus.md) | Learn how to use list, form, column, cell, and field context menus to navigate and manage records efficiently | Improve productivity and administration using ServiceNow context menus |